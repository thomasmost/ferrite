...
mod tests {
    ...
    extern "C" fn localtime(timep: *mut sys::time_t) -> *mut sys::tm {
        ...
        static mut FAKE: sys::tm = unsafe { core::mem::zeroed() };
        unsafe {
            FAKE.tm_sec = 5;
            FAKE.tm_min = 32;
            FAKE.tm_hour = 14;
            FAKE.tm_mday = 11;
            FAKE.tm_mon = 7; // 0-based: August
            FAKE.tm_year = 126; // years since 1900
            FAKE.tm_wday = 2; // Tuesday
            core::ptr::addr_of_mut!(FAKE)
        }
    }
